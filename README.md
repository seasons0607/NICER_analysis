...
## Extra Option
- If you want to change the criteria of the screening of <code>nicerl2</code>, you can add some options in line 61 of <code>nicer.py</code>. Please also see the help page of nicerl2.
